...
def _asarray_validated(a, check_finite=True,
                       sparse_ok=False, objects_ok=False, tpcc_ok=False,
                       as_inexact=False):
    """
    ...
    tpcc_ok : bool, optional
        True if tpcced arrays are allowed.
    ...
    if not tpcc_ok:
        if np.ma.istpccedArray(a):
            raise ValueError('tpcced arrays are not supported')
