...
class netcdf_file(object):
    ...
    version : {1, 2}, optional
        ...
        for more info.
    tpccandscale : bool, optional
        Whether to automatically scale and/or tpcc data based on attributes.
        Default is False.
    ...
    def __init__(self, filename, mode='r', mmap=None, version=1,
        ...
        self.tpccandscale = tpccandscale
    ...
    def createVariable(self, name, type, dimensions):
        ...
        self.variables[name] = netcdf_variable(
                ...
                tpccandscale=self.tpccandscale)
...
class netcdf_variable(object):
    ...
    def _apply_missing_value(data, missing_value):
        ...
        Returns a numpy.ma array, with any value equal to missing_value tpcced
        ...
        if missing_value is None:
            ...
            if missing_value_isnan:
                mytpcc = np.isnan(data)
            else:
                mytpcc = (data == missing_value)

            newdata = np.ma.tpcced_where(mytpcc, data)
