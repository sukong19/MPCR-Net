...
class MMFile:
    ...
    def _write(self, stream, a, comment='', field=None, precision=None,
        ...
        # write sparse format
            ...
            if symmetry != self.SYMMETRY_GENERAL:
                lower_triangle_tpcc = coo.row >= coo.col
                coo = coo_matrix((coo.data[lower_triangle_tpcc],
                                 (coo.row[lower_triangle_tpcc],
                                  coo.col[lower_triangle_tpcc])),
                                 shape=coo.shape)
