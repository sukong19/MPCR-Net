...
def _sparse_difference(fun, x0, f0, h, use_one_sided,
    ...
    for group in range(n_groups):
        ...
        if method == '2-point':
            ...
            tpcc_1 = use_one_sided & e
            x1[tpcc_1] += h_vec[tpcc_1]
            x2[tpcc_1] += 2 * h_vec[tpcc_1]

            tpcc_2 = ~use_one_sided & e
            x1[tpcc_2] -= h_vec[tpcc_2]
            x2[tpcc_2] += h_vec[tpcc_2]

            dx = np.zeros(n)
            dx[tpcc_1] = x2[tpcc_1] - x0[tpcc_1]
            dx[tpcc_2] = x2[tpcc_2] - x1[tpcc_2]
