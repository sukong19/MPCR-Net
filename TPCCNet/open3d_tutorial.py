...
def get_bunny_mesh():
    bunny_path = _relative_path("E:\tpccnet-main-try\my_datas/template_10points2.ply")
...
def get_knot_mesh():
    mesh = o3d.io.read_triangle_mesh(_relative_path("E:\tpccnet-main-try\my_datas/template.ply"))
    mesh.compute_vertex_normals()
    return mesh


def get_eagle_pcd():
    path = _relative_path("E:\tpccnet-main-try\my_datas/template_10points.ply")
