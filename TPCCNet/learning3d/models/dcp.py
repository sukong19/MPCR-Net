...
sys.path.append('E:\Mtmpe-Net')
from TPCCNet.learning3d.ops import transform_functions as transform
from TPCCNet.learning3d.utils import Transformer, SVDHead, Identity
